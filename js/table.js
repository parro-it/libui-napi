...
class UiTable extends UiControl {
	...
	appendTextColumn(name, textModelColumn, textEditableModelColumn, colorModelColumn) {
		return Table.appendTextColumn(this.handle, name, textModelColumn,
									  textEditableModelColumn, colorModelColumn);
	}
	...
	appendImageTextColumn(name, imageModelColumn, textModelColumn,
						  textEditableModelColumn, colorModelColumn) {
		return Table.appendImageTextColumn(this.handle, name, imageModelColumn,
										   textModelColumn, textEditableModelColumn,
										   colorModelColumn);
	}

	appendCheckboxColumn(name, checkboxModelColumn, checkboxEditableModelColumn) {
		return Table.appendCheckboxColumn(this.handle, name, checkboxModelColumn,
										  checkboxEditableModelColumn);
	}

	appendCheckboxTextColumn(name, checkboxModelColumn, checkboxEditableModelColumn,
							 textModelColumn, textEditableModelColumn, colorModelColumn) {
		return Table.appendCheckboxTextColumn(
			this.handle, name, checkboxModelColumn, checkboxEditableModelColumn,
			textModelColumn, textEditableModelColumn, colorModelColumn);
	}
	...
	appendButtonColumn(name, buttonModelColumn, buttonClickableModelColumn) {
		return Table.appendButtonColumn(this.handle, name, buttonModelColumn,
