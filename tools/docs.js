...
renderAll(['UiButton', 'js/{button.js,ui-control.js}'],
		  ...
		  ['UiGrid', 'js/{grid.js,ui-control.js}'],
		  ...
		  ['UiLabel', 'js/{label.js,ui-control.js}'],
		  ['UiMenu', 'js/{menu.js,ui-control.js}'], ['UiMenuItem', 'js/menu.js'],
		  [
			  'UiMultilineEntry',
